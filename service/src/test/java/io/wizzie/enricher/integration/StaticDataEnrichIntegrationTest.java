...
public class StaticDataEnrichIntegrationTest {
    ...
    public void staticDataEnrichShouldWork() throws Exception {
        ...
        KeyValue<String, Map<String, Object>> kvStream11 = new KeyValue<>("KEY_11", input1Msg1);
        ...
        KeyValue<String, Map<String, Object>> expectedKvStream11 = new KeyValue<>("KEY_11", expectedMsg11);
        ...
        KeyValue<String, Map<String, Object>> kvStream12 = new KeyValue<>("KEY_12", input1Msg2);
        ...
        KeyValue<String, Map<String, Object>> expectedKvStream12 = new KeyValue<>("KEY_12", expectedMsg12);
        ...
        KeyValue<String, Map<String, Object>> kvStream21 = new KeyValue<>("KEY_21", input2Msg1);
        ...
        KeyValue<String, Map<String, Object>> expectedKvStream21 = new KeyValue<>("KEY_21", expectedMsg21);
        ...
        KeyValue<String, Map<String, Object>> kvStream22 = new KeyValue<>("KEY_22", input2Msg2);
        ...
        KeyValue<String, Map<String, Object>> expectedKvStream22 = new KeyValue<>("KEY_22", expectedMsg22);
        ...
        KeyValue<String, Map<String, Object>> kvStream31 = new KeyValue<>("KEY_31", input3Msg1);
        ...
        KeyValue<String, Map<String, Object>> expectedKvStream31 = new KeyValue<>("KEY_31", expectedMsg31);
