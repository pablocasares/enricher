...
public class QueryGlobalTablePartitionByIntegrationTest {
    ...
    public void queryWithGlobalTableShouldWork() throws Exception {
        ...
        configuration.put("file.bootstraper.path", Thread.currentThread().getContextClassLoader().getResource("query-with-global-table-partition-by-integration-test.json").getFile());
