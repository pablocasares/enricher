...
public class QueryGlobalTablePartitionByIntegrationTest {
    ...
    public void queryWithGlobalTableShouldWork() throws Exception {
        ...
        configuration.put("file.bootstrapper.path", Thread.currentThread().getContextClassLoader().getResource("query-with-global-table-partition-by-integration-test.json").getFile());
        ...
        message1.put("coordinate", "X");
        message1.put("b", "VALUE_B");
        message1.put("c", "VALUE_C");

        KeyValue<String, Map<String, Object>> kvStream1 = new KeyValue<>("I", message1);

        // INPUT MESSAGE 2
        Map<String, Object> message2 = new HashMap<>();
        message2.put("coordinate", "Y");
        message2.put("v", "VALUE_V");
        message2.put("w", "VALUE_W");

        KeyValue<String, Map<String, Object>> kvStream2 = new KeyValue<>("J", message2);

        // INPUT MESSAGE 3
        Map<String, Object> message3 = new HashMap<>();
        message3.put("coordinate", "Z");
        message3.put("j", "VALUE_J");
        message3.put("k", "VALUE_K");

        KeyValue<String, Map<String, Object>> kvStream3 = new KeyValue<>("K", message3);
        ...
        expectedData1.put("coordinate", "X");
        ...
        expectedData2.put("coordinate", "Y");
        ...
        expectedData3.put("coordinate", "Z");
