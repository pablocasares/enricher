...
public class QueryPartitionByIntegrationTest {
    ...
    public void queryWithDifferentPartitionByShouldWork() throws Exception {
        ...
        configuration.put("file.bootstrapper.path", Thread.currentThread().getContextClassLoader().getResource("query-partition-by-integration-test.json").getFile());
        ...
        IntegrationTestUtils.produceKeyValuesSynchronously(INPUT_TABLE_1_TOPIC, Collections.singletonList(kvStream3), producerConfig, CLUSTER.time);
